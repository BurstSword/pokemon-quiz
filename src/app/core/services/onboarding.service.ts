...
const HELP_CONTENT: Record<GameModeId, GameHelpContent> = {
  shadow: {
    ...
    hintPenalty: 'Usar pistas reduce el bonus de la ronda.',
  },
  blur: {
  ...
  clues: {
    ...
    hintSummary: 'Cada pista extra reduce la puntuacion maxima de la ronda.',
    hintPenalty: 'Cuantas mas pistas uses, menos puntos ganas.',
  },
  connections: {
